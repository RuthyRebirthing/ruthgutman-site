...
**התוצר:** `promo/promo_ruthgutman.mp4` — 1080×1920, 30fps, 29 שניות, H.264+AAC, ~12.5MB (מתחת למגבלת סטטוס וואטסאפ).
מבנה: הירו וידאו הים (0-7s) → כרטיס שם (7-9.3s) → 5 "הבזקים" של דפי האתר בתוך mockup טלפון עם גלילה (9.3-23.3s) → כרטיס CTA עם הכתובת והטלפון (23.3-29s).
